...
namespace MIEL.web.Migrations
{
    ...
    [Migration("20260304111348_RemoveProdId")]
    partial class RemoveProdId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MIEL.web.Models.EntityModels.SalesItem", b =>
                {
                    ...
                    b.HasOne("MIEL.web.Models.EntityModels.procolrsizevarnt", "procolrsizevarnt")
                        .WithMany()
